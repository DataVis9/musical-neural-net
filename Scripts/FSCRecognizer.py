...
train_songs = pd.read_csv(io.BytesIO(uploaded['TrainDataSet2.csv']), skiprows=1)
test_songs = pd.read_csv(io.BytesIO(uploaded['TestDataSet2.csv']), skiprows=1)
train_labels = pd.read_csv(io.BytesIO(uploaded['TrainLabelsSet2.csv']), skiprows=1)
test_labels = pd.read_csv(io.BytesIO(uploaded['TestLabelsSet2.csv']), skiprows=1)
